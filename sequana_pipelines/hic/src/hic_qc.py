...
# Notes from TC, jan 2025
# Code found from phase genomics on 2025
# Modification. remove threshold.json needs, remove logo to have simple layout
# 
...
class HiCQC(object):
    ...
    def write_report(self, quiet=False):
